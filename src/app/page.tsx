...
export default function Home() {
  return(
    <div>
      ...
      <div>
        <Image src="/shoe.png" alt="shoe" className="pl-10 pr-10 h-85 w-81"/>
      ...
      <div>
        ...
        <div className="flex flex-wrap justify-between">
          <Image src="/image1.png" alt="shoe1"  className="w-full sm:w-[30%] mb-4 p-10" />
          <Image src="/image3.png" alt="shoe3" className="w-full sm:w-[30%] mb-4 p-10" />
          <Image src="/image2.png" alt="shoe2" className="w-full sm:w-[30%] mb-4 p-10" />
        </div>
        <div className="justify-center">
          <h1 className="text-xl p-10"><b>Featured</b></h1>
          <Image src="/featured.png" alt="running man" className="pl-10 pr-10 h-85 w-81"/>
        ...
        <div className="flex justify-center space-x-5">
          <Image src="/pastel.png" alt="hoodie and shoes" className="w-[30%] mb-4" />
          <Image src="/brown.png" alt="brown" className="w-[30%] mb-4" />
          <Image src="/yellow.png" alt="yellow" className="w-[30%] mb-4"/>
        </div>
        </div>
        <Footer/>
    </div>
